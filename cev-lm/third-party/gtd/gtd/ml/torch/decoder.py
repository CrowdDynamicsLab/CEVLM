...
class BeamDecoder(LeftRightDecoder):
    ...
    def decode(self, examples, encoder_output, weighted_value_estimators,
        ...
        for state in states_orig:
            ...
            # TODO: WARNING! In the future, the ValueEstimators in BeamDecoder._advance might break
    ...
    def _select_extensions(cls, extension_probs, beam_size):
        ...
        num_beams = int(batch_size / beam_size)
        ...
        return batch_indices.flatten().astype(int), token_indices.flatten().astype(int)
