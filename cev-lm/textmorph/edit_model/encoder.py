...
class Encoder(Module):
    def __init__(self, token_embedder, agenda_dim, edit_dim, hidden_dim, lamb_reg, norm_eps, norm_max, kill_edit, num_layers, rnn_cell_factory, perturb):
        """Construct Encoder.
        ...
        self.edit_encoder = EditEncoder(word_dim, edit_dim, lamb_reg, norm_eps, norm_max, perturb)
    ...
    def forward(self, encoder_input, draw_samples=False, draw_p = False):
        ...
        if len(edit_embed.shape) < 2:
            edit_embed = edit_embed.unsqueeze(0)
