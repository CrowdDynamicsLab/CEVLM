...
# Delta Commands
# sh examples/style-transfer/decode_example.sh ./mucoco/speed_0.5 ./mucoco/speed_0.5/output classification debug
# sh examples/style-transfer/decode_example.sh ./mucoco/speed_0.5 ./mucoco/speed_0.5/output usim_classify run_and_evaluate
# sh ./examples/style-transfer/evaluate.sh ./mucoco/speed_0.5 ./mucoco/data/speed_0.5/output/prediction.txt
...
PRIMARYMODEL=gpt2
STSMODEL=./mucoco/training_stsbenchmark_gpt2-2023-04-22_09-55-19
CLASSIFIERMODEL=./${FEATURE}_control/gpt2/trainer_checkpoint/checkpoint-best
...
then
    python -W ignore -u decode.py\
        --data $DATA_DIR/source.txt:$DATA_DIR/target.txt\
        --model $model\
        --tokenizer $tokenizer\
...
then
    python -W ignore -u decode.py\
        --data $DATA_DIR/source_test.txt:$DATA_DIR/target_test.txt\
        --model $model\
        --tokenizer $tokenizer\
        --model_types $model_types\
        --betas $betas\
